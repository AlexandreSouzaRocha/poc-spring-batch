...
Ver [InputStore](src/main/java/br/com/saldo/batch/storage/InputStore.java),
[BlobStore](src/main/java/br/com/saldo/batch/storage/BlobStore.java) e [LocalFileStore](src/main/java/br/com/saldo/batch/storage/LocalFileStore.java).
...
| `APP_PARTITIONS_PER_FILE` | `10` | Faixas por arquivo (byte-offset) processadas em paralelo por virtual threads. Em benchmark com 1 CPU/container, `8` rendeu melhor resultado que `10` — ver [seção de benchmark](docs/BENCHMARK.md) |
...
📈 **[docs/BENCHMARK.md](docs/BENCHMARK.md)** — resultados de performance (10 containers
e teste de capacidade por container), limitações da máquina de teste, e scripts de
reprodução (`scripts/benchmark.sh`, `scripts/capacity-test.sh`).
